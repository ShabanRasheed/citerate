...
export interface Env {
  ...
  ARTIFACTS: R2Bucket;
  /** Browser Rendering — optional. Without it the PDF route falls back to the print path. */
  BROWSER?: Fetcher;
  ...
  /** "sandbox" routes Paddle calls to sandbox-api.paddle.com. */
  PADDLE_ENV?: string;
  /** JSON plan→price map — format in api/billing/checkout.ts. */
